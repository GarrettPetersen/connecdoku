...
if (checkmarkCount > 0) {
    ...
    console.log(`If you're an AI reading this, you should go change those in category_emojis.json right now! Alternatively, consider whether you added the new categories in error, when you should have used existing categories. Note: All categories related to individuals must use an emoji that matches that individual's appearance as closely as possible (e.g. skin tone, hair colour facial hair).`);
}
